    ...
    <div className={`${ isSubmitted ? "hidden" : "flex flex-row justify-center pt-[5%] pb-[30px]"}`}>
        ...
        >
            ...
            <div className="flex flex-row justify-star pt-8">
                <Image src={phone} alt="phone" className="w-[15%] h-[120%]" />
            ...
            <div className="flex flex-row justify-start pt-8">
                <Image src={mail} alt="mail" className="w-[15%]" />
            ...
            <div className="flex flex-row justify-start pt-8">
                <Image src={location} alt="location" className="w-[15%] h-[60%] aspect-square" />
            ...
            <div className="flex flex-row gap-4 justify-start pt-[4rem] pb-[2rem]">
                <Image src={ fb_logo } alt="fblogo" className="w-[10%] "/>
                <Image src={ linkedin_logo } alt="fblogo" className="w-[10%] aspect-square"/>
            </div>
        </motion.div>
        <motion.div
            initial={{opacity: 0}}
