        ...
        <div className="flex flex-col justify-center items-center mt-40 overflow-x-hidden px-40 ">
            <div className="grid grid-cols-2 place-self-center mx-40">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <Image src="/assets/datatheft.png" alt="datatheft" draggable="false" className="w-[300px]" width={1080} height={1080}/>
                </motion.div> 
                    <motion.p 
                        initial={{ opacity: 0}}
                        whileInView={{ opacity: 1}}
                ...
                >
                    File Integrity Monitoring (FIM&rsquo; and Data Theft Detection
                </motion.h1>
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        >
                            <Image src="/assets/wazuh-fim-module.jpg" alt="Wazuh File Integrity Monitoring (FIM) and Data Theft Detection" draggable="false" width={600} height={600}/>
                        </motion.div>
                </div>
                <motion.h1
                    initial={{ opacity: 0, y: 50}}
                ...
                <div className="grid grid-cols-2">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Image src="/assets/wazuh-dash.jpg" alt="Wazuh File Integrity Monitoring (FIM) and Data Theft Detection" draggable="false" width={600} height={600}/>
                    </motion.div>
                    <motion.p
                        initial={{ opacity: 0, x: 100}}
                        whileInView={{ opacity: 1, x: 0 }}
                ...
                <div className="grid grid-cols-2">
                    ...
                    <motion.div
                        ...
                        className="w-3/4 self-center place-self-center"
                    >
                        <Image src="/assets/wazuh-sca.jpg" alt="Wazuh File Integrity Monitoring (FIM) and Data Theft Detection" draggable="false" width={600} height={600}/>
                    </motion.div>
                </div>
                <motion.h1
                    initial={{ opacity: 0, y: 50}}
                ...
                <motion.div
                    ...
                    className="w-3/4 self-center place-self-center"
                >
                    <Image src="/assets/wazuh-unauthorized-usb-drive-event.webp" alt="Wazuh File Integrity Monitoring (FIM) and Data Theft Detection" draggable="false" width={600} height={600}/>
                </motion.div>
            </motion.div>
        </div>
    </>
