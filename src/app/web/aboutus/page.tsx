  ...
  return (
    <div id="aboutus" className="flex flex-col overflow-hidden justify-center">
        ...
        <motion.div 
            ...
            <img src="/assets/aboutus.png" draggable={false} alt="aboutus" className="sm:block hidden w-auto h-auto"/>
            <img src="/assets/aboutusmobile.png" draggable={false} alt="aboutus-mobile" className="sm:hidden w-auto h-auto"/>
            <img src="/assets/aboutusmobile1.png" draggable={false} alt="aboutus-mobile1" className="sm:hidden w-auto h-auto p-8"/>
