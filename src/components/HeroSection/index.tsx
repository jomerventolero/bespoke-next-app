...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col sm:px-20 h-screen">
      <motion.h1 
        initial={{ opacity: 0, scale: 0.5 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.8, delay: 0.5, ease: [0, 0.71, 0.2, 1.01] }}
        className="font-bold text-md sm:text-6xl py-4 pt-[100%] sm:pt-[28%] md:pt-[60%] lg:pt-[65%] xl:pt-[28%] px-4 self-start bg-gradient-to-bl from-slate-500 to-slate-800 bg-clip-text text-transparent z-20 drop-shadow-2xl parallax"
        data-speed="0.4"
      >
      ...
      <Image className="absolute left-0 w-screen h-screen object-cover z-10 parallax" src="/assets/office.jpg" width={1600} height={800} alt="office" data-speed="0.3"/>
    </div>
  )
}
