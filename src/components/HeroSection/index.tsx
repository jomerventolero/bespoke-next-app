  ...
  return (
    <div className="flex flex-col sm:px-20 sm:h-screen h-[40vh] bg-dot-black/[0.2]">
      <motion.h1 
        ...
        className="font-bold text-md sm:text-6xl py-4 pt-[40%] sm:pt-[28%] md:pt-[60%] lg:pt-[28%] px-4 self-start bg-gradient-to-bl from-slate-500 to-slate-800 bg-clip-text text-transparent z-20 drop-shadow-2xl parallax"
        data-speed="0.4"
      >
      ...
      <Image className="absolute sm:right-20 top-[70px] sm:top-32 w-screen sm:w-[55%] md:hidden lg:block sm:h-[75%] z-10 parallax sm:rounded-xl" src="/assets/herobg.jpg" width={1200} height={800} alt="office" data-speed="0.3"/>
      <Image className="absolute left-0 w-screen h-full object-cover hidden sm:hidden md:block lg:hidden z-10 parallax" src="/assets/office.jpg" width={1600} height={800} alt="office" data-speed="0.3"/>
    </div>
  )
}
